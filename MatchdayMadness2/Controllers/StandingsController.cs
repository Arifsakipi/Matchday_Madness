...
namespace MatchdayMadness2.Controllers
{
    public class StandingsController : Controller
    {
        ...
        public ActionResult Create(Standings standings)
        {
            ...
            ViewBag.Leagues = new SelectList(_db.Leagues, "LeagueId", "Name", standings.Leagues);
            ViewBag.Teams = new SelectList(_db.Teams, "id", "Name", standings.Teams);
            return View(standings);
        }
        ...
        public ActionResult Edit(Standings standingsNewData)
        {
            if (ModelState.IsValid)
            {
                ...
                standings.Leagues = standingsNewData.Leagues;
                standings.Teams = standingsNewData.Teams;
            ...
            ViewBag.Leagues = new SelectList(_db.Leagues, "LeagueId", "Name", standingsNewData.Leagues);
            ViewBag.Teams = new SelectList(_db.Teams, "id", "Name", standingsNewData.Teams);
