...
namespace MatchdayMadness2.Controllers
{
    ...
    {
        private static List<MatchdayMadness.Presentation.Models.Results> results = new List<MatchdayMadness.Presentation.Models.Results>();
        ...
        public ActionResult Create(MatchdayMadness.Presentation.Models.Results newResults)
        {
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(MatchdayMadness.Presentation.Models.Results resultsNewData)
        {
            try
            {
